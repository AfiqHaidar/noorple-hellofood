        ...
        <div className='flex flex-col'>
            ...
            <div className='flex items-center justify-between flex-wrap gap-4'>
                ...
                <p className='font-normal text-[14px] text-white opacity-50'>
                    Copyright © 2022 - 2023 HelloFood. All rights reserved.
                </p>
                <div className='flex gap-4'>
                    <img src="icon-instagram.png" alt="social" className='w-[24px] h-[24px] object-contain cursor-pointer' />
                    <img src="icon-twitter.png" alt="social" className='w-[24px] h-[24px] object-contain cursor-pointer' />
                    <img src="icon-whatsapp.png" alt="social" className='w-[24px] h-[24px] object-contain cursor-pointer' />
                </div>
            </div>
        </div>
